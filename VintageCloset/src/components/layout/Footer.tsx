        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4 pt-2">
              <a href="#" className="text-muted hover:text-accent-start transition-colors"><InstagramLogo size={20} /></a>
              <a href="#" className="text-muted hover:text-accent-start transition-colors"><TiktokLogo size={20} /></a>
              <a href="#" className="text-muted hover:text-accent-start transition-colors"><FacebookLogo size={20} /></a>
            </div>
          </div>
        </div>
